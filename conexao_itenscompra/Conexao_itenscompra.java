...
public class Conexao_itenscompra {
    ...
    public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_itenscompra(itenscompra_codigo,com_codigo,pro_codigo,"
                    + "tpp_codigo,nf_codigo,for_codigo,tpg_codigo,itc_embalagem,"
                    + "itc_qtde,itc_valorun,itc_desc,itc_valortotal) values("+itenscompra_codigo+","
                    + " \""+com_codigo+"\",\""+pro_codigo+"\",\""+tpp_codigo+"\","
                    + " \""+nf_codigo+"\",\""+for_codigo+"\",\""+tpg_codigo+"\","
                    + " \""+itc_embalagem+"\",\""+itc_qtde+"\",\""+itc_valorun+"\","
