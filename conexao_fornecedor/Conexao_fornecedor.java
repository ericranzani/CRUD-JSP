    ...
    public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_fornecedor(for_codigo,for_nome,"
                    + "for_endereco,for_numero,for_bairro,for_cidade,for_uf,"
                    + "for_cnpjcpf,for_rgie,for_telefone,for_fax,for_celular,for_email) values("+for_codigo+","
                    + " \""+for_nome+"\",\""+for_endereco+"\","
                    + " \""+for_numero+"\",\""+for_bairro+"\","
                    + " \""+for_cidade+"\",\""+for_uf+"\",\""+for_cnpjcpf+"\","
                    + " \""+for_rgie+"\",\""+for_telefone+"\",\""+for_fax+"\","
