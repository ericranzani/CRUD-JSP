...
public class Conexao_produtos {
    ...
    public void inserirDados(){  
         ...
         try {  
            String query = "insert into tb_produtos(pro_codigo,pro_descricao,tpp_codigo,"
                    + "pro_precocusto,pro_precovenda,pro_estoque,pro_embalagem,pro_ipi) values("+pro_codigo+","
                    + " \""+pro_descricao+"\",\""+tpp_codigo+"\",\""+pro_precocusto+"\","
                    + " \""+pro_precovenda+"\",\""+pro_estoque+"\",\""+pro_embalagem+"\","
                    + " \""+pro_ipi+"\")";  
